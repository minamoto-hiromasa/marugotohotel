...
/***/ "./assets/src/js/controler-path.js":
/*!*****************************************!*\
  !*** ./assets/src/js/controler-path.js ***!
  \*****************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "controlerPath": () => (/* binding */ controlerPath)
/* harmony export */ });
...
var controlerPath = {
  common: {
    init: function init() {
      ...
      try {
        var _loop = function _loop() {
          ...
          slider.init(function () {
            new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__.default('.' + slider.glideEl.classList[0], glideOptions).mount();
          });
        };
      ...
      var targetElems = document.getElementsByClassName('expand-content');

      var _iterator3 = _createForOfIteratorHelper(targetElems),
          _step3;
  ...
  home: {
    init: function init() {
      var smController = new (scrollmagic__WEBPACK_IMPORTED_MODULE_1___default().Controller)();
      ...
      if (menuItems.length > 0 && (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.isQueryMatch)()) {
        ...
        try {
          var _loop3 = function _loop3() {
            ...
            if (!triggerTarget) {
              console.info('対象のコンテンツが見つかりません メニュー: ', menuItem.className.replace('menu-', ''));
            }
...
var setupGallerySlider = /*#__PURE__*/function () {
  function setupGallerySlider(elm, options) {
    _classCallCheck(this, setupGallerySlider);
  ...
  _createClass(setupGallerySlider, [{
    key: "init",
    value: function init(callback) {
      var imageGroup = this.group.querySelectorAll('img');
      this.glideEl = document.createElement('div');
      var trackElm = document.createElement('div');
      var ulElm = document.createElement('ul'); // Arrow elements
      ...
      arrowContainer.appendChild(arrowRight); // Bullets elements
      ...
      imageGroup.forEach(function (image) {
        ...
        var imageDiv = document.createElement('div'); // const imageElm = document.createElement('img');
        // imageElm.src = image.attributes.src.value;
        // imageElm.classList.add('glide__slide__img');

        imageDiv.classList.add('image');
        imageDiv.style.backgroundImage = "url(".concat(image.attributes.src.value, ")");
        listElm.classList.add('glide__slide');
        listElm.appendChild(imageDiv); // listElm.appendChild(imageElm);
      ...
      if (!this.hasArrow) this.glideEl.appendChild(bulletContainer); // const groupChildren = this.group.children;
  ...
  return setupGallerySlider;
}();

function observeNodes(callback) {
  var observer = new MutationObserver(function (mutaionsList) {
    callback(mutaionsList[0].target);
  });
  var entryContent = document.getElementById('main');
...
var setupExpandContent = /*#__PURE__*/function () {
  function setupExpandContent(elm, options) {
    _classCallCheck(this, setupExpandContent);

    this.target = elm;
    this.lines = options.lines;
  }

  _createClass(setupExpandContent, [{
    key: "init",
    value: function init() {
      var _this = this;
      ...
      var paragraph = this.target.getElementsByTagName('p')[0];
      var fontSize = window.getComputedStyle(paragraph).fontSize.replace('px', '');
      var lineHeight = fontSize * 1.9;
      var openParagraphHeight = this.target.clientHeight;
      var article = this.target.closest('article');
...
/* harmony import */ var _controler_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controler-path */ "./assets/src/js/controler-path.js");
/**
 * SASS
 */
...
function pathControler() {
  ...
  var fire = function fire(func) {
    if (func !== '' && _controler_path__WEBPACK_IMPORTED_MODULE_1__.controlerPath[func] && typeof _controler_path__WEBPACK_IMPORTED_MODULE_1__.controlerPath[func].init === 'function') {
      _controler_path__WEBPACK_IMPORTED_MODULE_1__.controlerPath[func].init();
    }
  };
