...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'noto-serif-japanese', 'https://fonts.googleapis.com/css2?family=Noto+Serif+JP&display=swap' );
    wp_enqueue_style( 'frontend', get_template_directory_uri() . '/assets/public/css/frontend.css', array(), '20231114-3' );
    ...
    wp_enqueue_script( 'frontend', get_template_directory_uri() . '/assets/public/js/frontend.js', array(), '20231114-3', true );
    wp_enqueue_script( 'ryumin', '//code.typesquare.com/static/ZDbTe4IzCko%253D/ts106f.js', array(), '20211118', true );
}
