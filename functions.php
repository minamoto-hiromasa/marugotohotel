...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'frontend', get_template_directory_uri() . '/assets/public/css/frontend.css', array(), '20231109-1' );
    ...
    wp_enqueue_script( 'frontend', get_template_directory_uri() . '/assets/public/js/frontend.js', array(), '20231109-1', true );
